...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, backgroundColor: "rgba(255, 255, 255, 0.6)" },
  weekHeadingContainer: { paddingVertical: 8, alignItems: "center" },
  weekHeadingText: { fontSize: 18, fontWeight: "bold", color: "#064f62ff" },
  tableContainer: {
  ...
  weekdayText: { fontWeight: "bold", color: "#064f62ff" },
  timeHeaderText: { fontWeight: "bold", color: "#064f62ff" },
  timeText: { color: "#064f62ff", fontSize: 11 },
  dayCell: {
    minHeight: 50,
    borderWidth: 0.5,
    borderColor: "#aeacabff",
